        ...
        <div className='SearchBoxContainer'>
            <div className='SearchBox'>
                <div className='searchIcon'>
                    <svg focusable="false" fill='#ccc' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                />
                <div className='searchIcon'>
                    <svg className="goxjub" focusable="false" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='searchIcon'>
                    <svg className="Gdd5U" focusable="false" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg">
